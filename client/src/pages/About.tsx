...
import { slideUp, slideRight, fadeIn, staggerContainer } from '@/lib/animations';
...
const About = () => {
  const { createScrollAnimation, createParallaxEffect, createRevealAnimation } = useGsapAnimations();
  ...
  const timeline = [
    {
      ...
      description: "Kingsborough Church was founded with a vision to be a light in the city, starting with just a handful of committed believers."
    },
    {
      year: "2013",
      title: "First Home",
      description: "Moved into our first permanent location, enabling us to expand our community outreach initiatives."
    },
    {
      year: "2016",
      title: "Community Growth",
      description: "Surpassed 500 members and launched our first satellite campus to reach more neighborhoods."
    },
    {
      year: "2020",
      title: "Digital Ministry",
      description: "Pioneered our digital ministry, reaching thousands globally through online services and resources."
    }
  ];
  ...
  const coreValues = [
    {
      icon: "fas fa-heart",
      title: "Love",
      description: "Demonstrating Christ's unconditional love in everything we do, to everyone we meet."
    },
    {
      icon: "fas fa-hands-helping",
      title: "Service",
      description: "Serving others with humility and compassion as an expression of our faith."
    },
    {
      icon: "fas fa-seedling",
      title: "Growth",
      description: "Fostering spiritual, personal, and communal growth through discipleship and learning."
    },
    {
      icon: "fas fa-users",
      title: "Community",
      description: "Building authentic relationships where people belong, connect, and support each other."
    },
    {
      icon: "fas fa-globe-africa",
      title: "Impact",
      description: "Making a meaningful difference in our city, nation, and world through purposeful action."
    },
    {
      icon: "fas fa-church",
      title: "Worship",
      description: "Celebrating God's presence through passionate, authentic expressions of worship."
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover Kingsborough Church's story, mission, and leadership. Learn about our heart for the community and vision to be a light in the city." />
      </Helmet>
      ...
      >
        ...
        >
          ...
          >
            Building a community where faith is lived, love is experienced, and everyone is valued.
          </motion.p>
        </motion.div>
        ...
        >
          <div className="text-white text-sm mb-2 font-light tracking-wider">DISCOVER OUR STORY</div>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-8 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 section-content">
              <motion.div
                ...
                variants={slideUp()}
              >
                <h2 className="text-3xl md:text-5xl font-montserrat font-bold mb-6 text-deepPurple">Who We Are</h2>
                <div className="h-1 w-24 bg-gold mb-8"></div>
                <p className="text-lg md:text-xl leading-relaxed mb-8 text-gray-700">
                  Kingsborough Church is a vibrant community of believers passionate about encountering God, growing together, and making a positive impact in our city and beyond.
                </p>
                <p className="text-lg leading-relaxed mb-8 text-gray-700">
                  Founded on the principles of authentic faith and genuine love, we are committed to creating an environment where everyone feels welcome, regardless of background or life stage.
                </p>
                <p className="text-lg leading-relaxed mb-10 text-gray-700">
                  Our community is diverse yet united - a spiritual family where honest relationships thrive and where we support each other through life's journey.
                </p>
                
                {/* Logo Watermark (Low Opacity) */}
                <div className="opacity-10 absolute bottom-0 left-0 w-72 hidden lg:block">
                  <svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20,50 L40,20 L60,50 L80,20 L100,50 L120,20 L140,50 L160,20 L180,50" stroke="#000" strokeWidth="5" fill="none"/>
                    <path d="M40,80 L160,80" stroke="#000" strokeWidth="5" fill="none"/>
                  </svg>
                </div>
              </motion.div>
            </div>
      ...
      >
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-montserrat font-bold mb-4 text-deepPurple">Our Story</h2>
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            <div className="timeline-connector absolute left-8 md:left-1/2 top-0 bottom-0 w-1 bg-lilac transform md:-translate-x-1/2"></div>
      ...
      >
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-5xl font-montserrat font-bold mb-4 text-deepPurple">Our Vision & Mission</h2>
            <div className="h-1 w-20 bg-gold mx-auto mb-6"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
            ...
            >
              <h3 className="text-3xl md:text-4xl font-montserrat font-bold mb-6 text-deepPurple">Our Vision</h3>
            ...
            <motion.div 
              ...
              className="mv-card bg-deepPurple/5 rounded-xl p-8 md:p-10 shadow-lg border-t-4 border-gold"
            >
              <h3 className="text-3xl md:text-4xl font-montserrat font-bold mb-6 text-deepPurple">Our Mission</h3>
              <p className="text-lg md:text-xl leading-relaxed text-gray-700 mb-6">
      ...
      >
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-5xl font-montserrat font-bold mb-4 text-deepPurple">Core Values</h2>
            <div className="h-1 w-20 bg-gold mx-auto mb-6"></div>
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-gray-700">
      ...
      >
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-5xl font-montserrat font-bold mb-4 text-deepPurple">Meet Our Leadership</h2>
            <div className="h-1 w-20 bg-gold mx-auto mb-6"></div>
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-gray-700">
      ...
      >
        ...
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')` }}
        ></div>
        ...
        <div className="container relative z-10 px-4 lg:px-8 mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-montserrat font-bold mb-6 text-white">Join Our Story</h2>
            <p className="text-xl md:text-2xl text-white/90 font-light mb-10">
              Be part of a community that's making a difference. Walk the journey with us. Experience the transformation.
            </p>
