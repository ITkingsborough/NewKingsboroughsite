...
const Hadassah = () => {
  ...
  return (
    <>
      ...
      <div className="pt-24">
        {/* Hero Section */}
        <section data-nav-theme="dark" className="relative h-96 md:h-[500px] flex items-center parallax" style={{ backgroundImage: `url('/uploads/gallery/WhatsApp%20Image%202025-08-07%20at%2011.33.15.jpg')` }}>
