  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentImageIndex(
        (prevIndex) => (prevIndex + 1) % purposeImages.length,
      );
    }, 4000);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Join Hadassah, the vibrant women's ministry at Kingsborough Church. Empowering women through fellowship, prayer, and spiritual growth."
        />
      </Helmet>
      <div className="pt-24">
        {/* Hero Section */}
        <section
          data-nav-theme="dark"
          className="relative h-96 md:h-[500px] flex items-center parallax"
          style={{
            backgroundImage: `url('/uploads/gallery/WhatsApp%20Image%202025-08-07%20at%2011.33.15.jpg')`,
          }}
        >
          ...
          <div className="container mx-auto px-4 lg:px-8 z-10">
            <motion.div
              ...
              className="max-w-4xl"
            >
              <h1 className="text-5xl md:text-6xl font-montserrat font-bold text-white mb-6 tracking-tight text-shadow">
                Hadassah
              </h1>
              ...
              <p className="text-xl text-white opacity-80 max-w-3xl">
                Empowering women through faith, fellowship, and spiritual growth
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 lg:px-8">
            ...
            >
              ...
              >
                Hadassah is our vibrant women's ministry, named after the
                biblical Queen Esther, whose Hebrew name was Hadassah. Like
                Queen Esther, we believe every woman has been placed "for such a
                time as this" to make a significant impact in God's kingdom and
                in our community.
              </motion.p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                className="space-y-6"
              >
                <h3 className="text-3xl font-montserrat font-bold text-deepPurple">
                  Our Purpose
                </h3>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Hadassah exists to create a safe and nurturing environment
                  where women can grow spiritually, build meaningful
                  relationships, and discover their God-given purpose. We
                  believe in the power of sisterhood and the strength that comes
                  from walking together in faith.
                </p>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <p>
                      <strong>Fellowship:</strong> Building deep, authentic
                  ...
                  <div className="flex items-start">
                    ...
                    <p>
                      <strong>Prayer:</strong> Supporting one another through
                  ...
                  <div className="flex items-start">
                    ...
                    <p>
                      <strong>Growth:</strong> Encouraging spiritual maturity
          ...
          <div className="container mx-auto px-4 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Our ministry offers various opportunities for women to connect,
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-2xl font-montserrat font-semibold mb-4 text-deepPurple">
                  Monthly Gatherings
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  Join us for inspiring monthly meetings featuring guest
                  speakers, worship, and fellowship. A time to be refreshed and
                  encouraged in your faith journey.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Dive deeper into God's Word through our weekly Bible study
                  sessions. Explore Scripture together and discover how it
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Serve our community through various outreach programs, charity
                  drives, and volunteer opportunities. Making a difference
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Experience the power of prayer through our dedicated prayer
                  times, prayer walks, and intercession sessions for our
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Enjoy fun social gatherings, retreats, and special events
                  designed to build friendships and create lasting memories
                  together.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed">
                  Connect with spiritual mothers and sisters who can guide,
                  support, and encourage you in your personal and spiritual
                  growth journey.
                </p>
              </motion.div>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Take a look at some of our memorable moments, outings, and
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl text-gray-700 leading-relaxed mb-8">
                  Whether you're new to faith or have been walking with Christ
                  for years, Hadassah welcomes you with open arms. Come as you
                  are and discover the joy of sisterhood in Christ.
                </p>
          ...
          <div className="container mx-auto px-4 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 opacity-90">
                Join a community of women who are passionate about growing in
                faith, building relationships, and making a difference in the
                world around them.
              </p>
