  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover our various ministries and how you can get involved in our church community."
        />
      </Helmet>
      <div className="pt-24">
        {/* Hero Section */}
        ...
        >
          ...
          <div className="container mx-auto px-4 lg:px-8 z-10">
            <motion.div
              ...
              className="max-w-3xl"
            >
              <h1 className="text-4xl md:text-5xl font-montserrat font-bold text-white mb-4 tracking-tight text-shadow">
                Our Ministries
              </h1>
              <p className="text-xl text-white opacity-90 font-light">
                Discover ways to connect, grow, and serve in our church
                community.
              </p>
            </motion.div>
          </div>
            ...
            <div className="container mx-auto px-4 lg:px-8">
              ...
              >
                <div className="mb-8">
                  ...
                  >
                    <i className="fas fa-arrow-left mr-2"></i> Back to All
                    Ministries
                  </button>
                </div>
                ...
                <div className="bg-lilac bg-opacity-10 p-8 rounded-lg mb-8">
                  ...
                  <p className="mb-6">
                    We'd love for you to be a part of our{" "}
                    {selectedMinistry.title}. Here's how you can get started:
                  </p>
          ...
          <section className="py-20 bg-white">
            <div className="container mx-auto px-4 lg:px-8">
              ...
              >
                ...
                <p className="text-lg">
                  We believe that everyone has unique gifts and abilities. Our
                  ministries provide opportunities for you to use your talents
                  to serve God and others while building meaningful
                  relationships.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="mb-8 max-w-2xl mx-auto">
                  We're here to help you find the perfect place to serve based
                  on your passions, gifts, and availability. Let us help you get
                  connected!
                </p>
                <button className="btn-primary">
                  Talk to a Ministry Coordinator
                </button>
              </motion.div>
            </div>
          </section>
